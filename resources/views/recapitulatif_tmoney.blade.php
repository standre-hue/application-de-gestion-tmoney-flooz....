...
<html>
    ...
    <body>
        ...
        <h4 class="text-center" " style="text-decoration: underline"> Liste des Transactions <span style="font-weight: bold">Tmoney</span> du <span style="font-weight: bold;"> {{ $date_debut }} </span> au  <span style="font-weight: bold">{{ $date_fin }}</span></h4>
        @else 
        ...
        <h5>Nombre Total de Retrait: <span style="font-weight: bold"> {{ $tmoney_nombre_retrait }} </span></h5>
        <h5>Nombre Total de Depot: <span style="font-weight: bold"> {{ $tmoney_nombre_depot }} </span></h5>
        <h5>Montant Total de Retrait: <span style="font-weight: bold"> {{ $tmoney_montant_total_retrait }} </span></h5>
        <h5>Montant Total de Depot: <span style="font-weight: bold"> {{ $tmoney_montant_total_depot }} </span></h5>
